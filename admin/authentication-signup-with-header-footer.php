...
<body class="bg-surface">
  ...
  <div class="wrapper">
    ...
    <form class="form-body" id="signupForm" method="POST" action="authentication/register.php">
  ...
  <div class="row g-3">
    ...
    <div class="col-12">
      ...
      <div class="ms-auto position-relative">
        ...
        <input type="email" name="email" class="form-control radius-30 ps-5" id="inputEmailAddress" placeholder="Email" required>
      </div>
    </div>
    ...
    $.ajax({
      ...
      success: function(response) {
        if (response.status == 'success') {
          ...
          // 2 sec baad login page redirect
          setTimeout(function() {
            window.location.href = 'login.php';
          }, 2000);
        } else {
          $('#signupMessage').html('<div class="alert alert-danger">'+response.message+'</div>');
        }
      },
      error: function() {
        $('#signupMessage').html('<div class="alert alert-danger">Something went wrong. Try again!</div>');
      }
    });
  });
});
