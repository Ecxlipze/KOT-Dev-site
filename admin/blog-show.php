       ...
       <!--start content-->
          <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Show Blog</div>
              <div class="ps-3">
...
<tr>
  ...
  <td>
    <h6 class="mb-0 fw-bold"><?= htmlspecialchars($row['blog_title']); ?></h6>
  </td>

  <td><?= htmlspecialchars($row['blog_author']); ?></td>
  ...
  <td>
    <div class="d-flex gap-3 fs-6">
      <a href="javascript:void(0);" 
         class="text-primary viewBlog" 
         data-id="<?= $row['id']; ?>">
        <i class="bi bi-eye-fill"></i>
      </a>

      <a href="blog-edit.php?id=<?= $row['id']; ?>" class="text-warning">
        <i class="bi bi-pencil-fill"></i>
      </a>

      <a href="javascript:void(0);" 
         class="text-danger deleteBlog" 
         data-id="<?= $row['id']; ?>">
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="viewInsightLabel">Blog Detail</h5>
...
$(document).ready(function() {
  ...
  let modal = new bootstrap.Modal(
    document.getElementById('viewInsightModal')
  );
  modal.show();
  ...
  $.ajax({
    ...
    error: function () {
      $('#modalInsightContent').html(
        '<p class="text-danger">Unable to load blog.</p>'
      );
    }
  });
});
