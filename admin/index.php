...
// Function to get total records in a table
                ...
                <div class="card radius-10">
                  <div class="card-body">
                      <div class="d-flex align-items-center">
                          <div>
                              <p class="mb-0 text-secondary">New Year</p>
                              <h4 class="my-1"><?php echo getTableCount($con, 'new_year'); ?></h4>
               ...
               <div class="col">
                  <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Insight</p>
                                <h4 class="my-1"><?php echo getTableCount($con, 'insights'); ?></h4>
               ...
               <div class="col">
                  <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Certificate Verification Center</p>
                               <h4 class="my-1"><?php echo getTableCount($con, 'certificates'); ?></h4>
                                <!-- <p class="mb-0 font-13 text-success"><i class="bi bi-caret-up-fill"></i> 4.6 from last week</p> -->
                            </div>
                            <!-- <div class="widget-icon-large bg-gradient-success text-white ms-auto"><i class="bi bi-currency-exchange"></i>
                            </div> -->
               ...
               <div class="col">
                  <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Event Management Center </p>
                               <h4 class="my-1"><?php echo getTableCount($con, 'events'); ?></h4>
                                <!-- <p class="mb-0 font-13 text-success"><i class="bi bi-caret-up-fill"></i> 4.6 from last week</p> -->
                            </div>
                            <!-- <div class="widget-icon-large bg-gradient-success text-white ms-auto"><i class="bi bi-currency-exchange"></i>
                            </div> -->
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                               ...
                               <h4 class="my-1"><?php echo getTableCount($con, 'news'); ?></h4>
                                <!-- <p class="mb-0 font-13 text-success"><i class="bi bi-caret-up-fill"></i> 4.6 from last week</p> -->
                            </div>
                            <!-- <div class="widget-icon-large bg-gradient-success text-white ms-auto"><i class="bi bi-currency-exchange"></i>
                            </div> -->
               ...
               <div class="col">
                  <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Appreciation Board </p>
                                <h4 class="my-1"><?php echo getTableCount($con, 'appreciation_board'); ?></h4>
                                <!-- <p class="mb-0 font-13 text-success"><i class="bi bi-caret-up-fill"></i> 4.6 from last week</p> -->
                            </div>
                            <!-- <div class="widget-icon-large bg-gradient-success text-white ms-auto"><i class="bi bi-currency-exchange"></i>
                            </div> -->
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                               ...
                               <h4 class="my-1"><?php echo getTableCount($con, 'blogs'); ?></h4>
                                <!-- <p class="mb-0 font-13 text-success"><i class="bi bi-caret-up-fill">

                                </i> 4.6 from last week</p> -->
                            </div>
                            <!-- <div class="widget-icon-large bg-gradient-success text-white ms-auto"><i class="bi bi-currency-exchange"></i>
                            </div> -->
                        </div>
               ...
               <div class="col">
                  <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Announcement </p>
                                <h4 class="my-1"><?php echo getTableCount($con, 'announcements'); ?></h4>
               ...
               <div class="col">
                  <!-- <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Case Study </p>
