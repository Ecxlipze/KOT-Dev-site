  ...
  <div class="row">
    <div class="col-lg-8 mx-auto">
      <div class="card">
        ...
        <form id="updateInsightForm" enctype="multipart/form-data">
...
$(document).ready(function() {
    ...
    // Live validation for special characters and length
    ...
    $("#updateInsightForm").submit(function(e){
        e.preventDefault();
        ...
        $.ajax({
            url: "subpages/update-insight.php",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
            success: function(res){
                if(res.trim() === "success"){
                    showToast("Insight updated successfully!", true);
                    setTimeout(() => {
                        window.location.href = "insight-show.php";
                    }, 1500);
                } else {
                    showToast(res);
                }
