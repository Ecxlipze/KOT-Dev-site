  ...
  <div class="wrapper">
       ...
       <header>
          <nav class="navbar navbar-expand-lg navbar-light bg-white rounded-0 border-bottom">
            <div class="container">
              <a class="navbar-brand" href="#"><img src="assets/images/Logo-admin.svg" width="140" alt=""/></a>
                ...
                <div class="col-12 col-xl-4 order-xl-2">
                  <div class="card-body p-4 p-sm-5">
                    ...
                    <p class="card-text mb-4">See your growth and get consulting support!</p>
                     <form class="form-body" id="loginForm" method="POST">
                   <div id="loginError" class="mb-3 text-danger"></div> 
            ...
            <div class="ms-auto position-relative">
                ...
                <input type="email" name="email" class="form-control radius-30 ps-5" id="inputEmailAddress" placeholder="Email">
                          ...
                          <!-- <div class="col-12 text-center">
                            <p class="mb-0">Don't have an account yet? <a href="authentication-signup-with-header-footer.php">Sign up here</a></p>
                          </div> -->
                        </div>
                    </form>
                 </div>
...
$(document).ready(function() {
    $('#loginForm').on('submit', function(e) {
        ...
        $.ajax({
            url: 'authentication/login.php', // your PHP login file
            type: 'POST',
            ...
            success: function(response) {
                if(response.status === 'success') {
                    ...
                    // show error dynamically in form
