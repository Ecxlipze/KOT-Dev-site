            ...
            <div class="container"> 
                <div class="row justify-content-center g-2 mt-4">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 d-flex justify-content-center">
                        <div class="support-card sup-16"></div>
                    </div>

                    <div class="col-lg-3 col-md-6 col-12 d-flex justify-content-center">
                        <div class="support-card sup-15"></div>
                    </div>

                    <div class="col-lg-3 col-md-6 col-12 d-flex justify-content-center">
                        <div class="support-card sup-14"></div>
                    </div>

                    <div class="col-lg-3 col-md-6 col-12 d-flex justify-content-center">
                        <div class="support-card sup-13"></div>
                    </div>
  ...
  <div class="container">
    ...
    <div class="swiper testimonial-slider">
      <div class="swiper-wrapper">
        ...
        <!-- Slide 2 (DUPLICATE – same structure) -->
        <div class="swiper-slide">
          <div class="testimonial-card">
        ...
        <section class="achieve-section text-center mt-5">
           <div class="container" style="align-items: start; text-align: start;"> <h2 class="section-title">
            ...
            <p class="section-title"
                style=" font-size: 22px; color: rgb(255, 255, 255); font-weight: 400;">We don’t
...
<script>
  const testimonialSwiper = new Swiper(".testimonial-slider", {
    ...
    spaceBetween: 40,
    loop: true,
    speed: 8000,              // higher = smoother & slower
