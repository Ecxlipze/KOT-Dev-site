    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-12 col-md-12" style="text-align: center; margin-top: 3%;">
        <h1 class="hero-title">
         ...
         <p class="hero-text" style="color: rgb(255, 255, 255); text-align: center; font-size: 26px; ">
...
/>
  ...
  <section class="solutions-wrapper">
    ...
    <section class="capabilities-section" style="background-color: rgba(0, 26, 45, 0.55); padding: 5% 0;"
>
    ...
    <section class="support-section text-center mt-5"style="padding: 5% 0; background-color: rgba(0, 26, 45, 0.55);">
    ...
    <br>
    <section class="achieve-section text-center mt-5 mb-5" style="padding: 5% 0;">
    ...
    <section class="work-section text-center mt-5" style="padding: 5% 0; background-color: rgba(0, 26, 45, 0.55);">
