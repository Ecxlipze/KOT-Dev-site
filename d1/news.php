...
<section class="news-hero">
  <div class="container text-center">
    <h1 class="news-hero-title">Latest Updates From KOT Enterprises
</h1>
    <p class="news-hero-text">
     Stay connected with the latest news, achievements, events, and innovation stories from KOT Enterprises. From new product releases to company milestones and industry insights, this is where our community stays updated.    </p>
  </div>
</section>
