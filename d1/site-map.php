    ...
    <div class="sitemap-column">
      ...
      <div class="sitemap-group">
        ...
        <ul class="sitemap-list">
          ...
          <li>
            <a href="why-kot.php">Why KOT</a>
            <ul>
              <li><a href="why-kot.php">Our Core Values</a></li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li><a href="board-of-directors.php">Message from Board of Directors</a></li>
              <li><a href="board-of-directors.php">We are Deeply Committed to</a></li>
              <li><a href="board-of-directors.php">Message from CEO</a></li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              ...
              <li><a href="gen-ai.php">Generative AI</a></li>
          ...
          <li>
            <a href="">Programs</a>
            <ul>
              <li><a href="venture.php">Venture Xceleration</a></li>
          ...
          <li>
            ...
            <ul>
              <li><a href="agileappsservice.php">AgileApps</a></li>
              <li><a href="appsculpt.php">App Sculpt</a></li>
              <li><a href="digittrail.php">Digittrail</a></li>
              <li><a href="graphoria.php">Graphiora</a></li>
              <li><a href="flawless.php">Flawless</a></li>
              <li><a href="merchanity.php">Merchantity</a></li>
              <li><a href="WebSculpture.php">Web Sculpture</a></li>
            </ul>
          </li>
