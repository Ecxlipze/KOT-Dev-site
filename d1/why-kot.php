   ...
   <div class="container-fluid">
    <div class="career-section-bg-image">
        ...
        <div class="career-section-text py-4">
            <h2 style="font-weight: 700; color: white; font-size: 46px;">Why KOT Enterprises</h2>
        </div>
        <div class="career-section-btn" style="background-color: white;">
            <a href="" style="color: black; font-weight: 800 !important;">Watch the Film</a>
        </div>
    </div>
   </div>
...
<div class="col-lg-6 p-0">
  <div class="impact-card impact-left h-100">
    ...
    <p class="impact-card-text" style="color: white;">
