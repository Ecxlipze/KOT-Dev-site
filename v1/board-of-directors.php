...
<div class="container">
  ...
  <picture>
    <!-- Mobile image -->
    <source media="(max-width: 767px)" srcset="../assets/images/board-of-director/c1m.png">
  ...
  <picture>
    <!-- Mobile image -->
    <source media="(max-width: 767px)" srcset="../assets/images/board-of-director/c2m.png">
  ...
  <picture>
    <!-- Mobile image -->
    <source media="(max-width: 767px)" srcset="../assets/images/board-of-director/c3m.png">
  ...
  <picture>
    <!-- Mobile image -->
    <source media="(max-width: 767px)" srcset="../assets/images/board-of-director/c4m.png">
