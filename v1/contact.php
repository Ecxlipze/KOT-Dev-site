...
<section class="contact-wrapper" style="opacity: 80%;">
  ...
  <div class="mb-4">
    <label>Name</label>
    <input type="text" name="name" class="form-control" maxlength="50" style="border: 1px solid black; margin-top: 3px;">
    <small class="text-danger" id="nameError" style="display:none;">Only letters allowed!</small>
  </div>
  ...
  <div class="mb-4">
    <label>Subject</label>
    <input type="text" name="subject" class="form-control" maxlength="50" style="border: 1px solid black; margin-top: 3px;">
    <small class="text-danger" id="subjectError" style="display:none;">Only letters allowed!</small>
  </div>

  <div class="mb-4">
    <label>Details</label>
    <textarea rows="5" name="message" class="form-control" style="border: 1px solid black; margin-top: 3px; resize: none;"></textarea>
    <small id="messageCount" style="float:right; font-size:12px; color:#555;">0/500</small>
  </div>
  ...
  <img src="../assets/images/contact/contact-1.png" class="icon-img" alt="Phone">
  <h6>Phone Number</h6>
  <p>
...
<div class="col-6 contact-item">
  <img src="../assets/images/contact/contact-3.png" class="icon-img" alt="Whatsapp">
  <h6>WhatsApp</h6>
  <p>
...
<div class="col-6 contact-item">
  <img src="../assets/images/contact/contact-4.png" class="icon-img" alt="Office">
  <h6>Office</h6>
  <p>Gulberg, Lahore</p>
</div>
