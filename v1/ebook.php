...
<body>
  ...
  <section class="kot-blog-banner">
    <div class="kot-blog-banner-inner">
      <h1 class="kot-blog-title">E-Book / Whitepaper</h1>
      <p class="kot-blog-subtitle">
        Knowledge designed for builders of the future.
      </p>
    </div>
  </section>
  <section class="kot-blog-intro-section">
    <div class="kot-blog-intro-card">
      <p>
        The KOT Ebook Library features curated digital publications on technology, entrepreneurship, leadership, and
        innovation. Every ebook is crafted to empower professionals, founders, and learners with insights that go beyond
        theory and into practical, future-ready thinking.
      </p>
    </div>
  </section>
