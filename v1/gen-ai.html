...
<!-- HERO SECTION -->
<section class="hero-section" style="padding: 60px 0;   background-image: url('../assets/images/generativeailight/genaibanner.jpg');
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <!-- Left Content -->
      <div class="col-lg-12 col-md-12" style="text-align: center; margin-top: 3%;">
        <h1 class="hero-title">
          Build Smarter Systems. Deliver Creative Outcomes.
        </h1>

         <p class="hero-text" style="color: black; text-align: center; font-size: 26px; ">
  ...
  <div class="container">
    <div class="row justify-content-center g-3 mt-4" >
      ...
      <div class="col-lg-2 col-md-4 col-8 ">
        <div class="solution-card sol-1" style="width: 205px; height: 220px;;;"></div>
      </div>

      <div class="col-lg-2 col-md-4 col-8 ">
        <div class="solution-card sol-2"  style="width: 205px; height: 220px;;;;"></div>
      </div>

      <div class="col-lg-2 col-md-4 col-8 ">
        <div class="solution-card sol-3"  style="width: 205px; height: 220px;;;;"></div>
      </div>

      <div class="col-lg-2 col-md-4 col-8 ">
        <div class="solution-card sol-4"  style="width: 205px; height: 220px;;;;"></div>
      </div>

      <div class="col-lg-2 col-md-4 col-8 ">
        <div class="solution-card sol-5"  style="width: 200px; height: 220px;;;;"></div>
      </div>
